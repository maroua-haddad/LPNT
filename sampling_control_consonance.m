function [Execution_time]= sampling_control_consonance(pnet,nsamples,num,max_values,version,consonance_degree,repertoire)

%repertoire = 'D:\Mes fichiers\mes études\thèse\LPNT\sampling\exp1\';
t0=cputime;
name = strcat('Dataset_control_consonance(',num2str(consonance_degree*100),'%)',num2str(num));
...
for i=1:nsamples
    ob= sample_pnet_control_consonance (pnet.dag,pnet.parameters,pnet.nodes_size,pnet.order,consonance_degree);
