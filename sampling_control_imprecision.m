function [Execution_time]= sampling_control_imprecision(pnet,nsamples,num,max_values,version,imprecision_degree,repertoire)

%repertoire = 'D:\Mes fichiers\mes études\thèse\LPNT\sampling\exp1\';


t0=cputime;
name = strcat('Dataset_control_imprecision(',num2str(imprecision_degree*100),'%)',num2str(num));
...
for i=1:nsamples
    ob= sample_pnet_control_imprecision (pnet.dag,pnet.parameters,pnet.nodes_size,pnet.order,imprecision_degree);
